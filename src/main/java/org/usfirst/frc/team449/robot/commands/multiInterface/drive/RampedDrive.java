...
public class RampedDrive<T extends Subsystem & DriveUnidirectional & SubsystemAHRS> extends PIDAngleCommand implements Loggable {
     ...
     */
    @JsonCreator
    public RampedDrive(@JsonProperty(required = true) double absoluteTolerance,
        ...
        this.rightRamp = rampComponent.clone();
    ...
    protected void usePIDOutput(double output) {
        rawOutput = output;
        double leftOutput = leftRamp.applyAsDouble(oi.getLeftRightOutputCached()[0]);
        double rightOutput = rightRamp.applyAsDouble(oi.getLeftRightOutputCached()[1]);
