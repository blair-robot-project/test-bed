...
public class RampedShiftingDrive<T extends Subsystem & DriveUnidirectional & SubsystemAHRS & DriveShiftable> extends RampedDrive {
     ...
     */
    @JsonCreator
    public RampedShiftingDrive(@JsonProperty(required = true) double absoluteTolerance,
