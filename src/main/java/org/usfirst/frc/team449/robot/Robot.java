...
public class Robot extends IterativeRobot {
    ...
    public void robotInit() {
        ...
        try {
            ...
            Map<?, ?> normalized = (Map<?, ?>) yaml.load(new FileReader(RESOURCES_PATH + "test_bed_map.yml"));
            ...
            robotMap = mapper.readValue(fixed, TestBedMap.class);
        } catch (IOException e) {
